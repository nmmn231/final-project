$(document).ready(function(){
            ...
            $(window).scroll(function(){
                ...
                if($(window).scrollTop()==$(".p01").offset().top){$("#player").attr("src","music/punk1.mp3");}
                if($(window).scrollTop()==$(".p02").offset().top){$("#player").attr("src","music/punk2.mp3");}
                if($(window).scrollTop()==$(".p03").offset().top){$("#player").attr("src","music/punk3.mp3");}
                if($(window).scrollTop()==$(".p04").offset().top){$("#player").attr("src","music/punk4.mp3");}
                if($(window).scrollTop()==$(".p05").offset().top){$("#player").attr("src","music/punk5.mp3");}
...
$(window).scroll(function(){
    ...
    if(wScroll >= $(".p01").offset().top && wScroll < $(".p02").offset().top){
        ...
        $(".character").attr("src","img/character06.png")
    ...
    }else if(wScroll >= $(".p05").offset().top){
...
$(window).scroll(function(){
    var wScroll = $(this).scrollTop();
    if(wScroll >= 9200 && wScroll < 9300){
        $(".character").css("opacity","0.8");
    }else if(wScroll >= 9300 && wScroll < 9400){
        $(".character").css("opacity","0.6");
    }else if(wScroll >= 9400 && wScroll < 9500){
        $(".character").css("opacity","0.4");
    }else if(wScroll >= 9500 && wScroll < 9650){
        $(".character").css("opacity","0.2");
    }else if(wScroll >= 9650){
